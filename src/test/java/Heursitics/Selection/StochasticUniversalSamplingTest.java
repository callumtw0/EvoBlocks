...
import org.example.Heuristics.SelectionHeuristics.StochasticUniversalSampling;
...
public class StochasticUniversalSamplingTest {
    ...
    private StochasticUniversalSampling susSelection;
    ...
    @BeforeEach
    public void setUp() {
        susSelection = new StochasticUniversalSampling();
    ...
    public void testRunReturnsCorrectNumberOfIndividuals() {
        int number = 3;
        ArrayList<Individual> selected = susSelection.run(population, number);
    ...
    public void testRunWithZeroNumber() {
        ArrayList<Individual> selected = susSelection.run(population, 0);
