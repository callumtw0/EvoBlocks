...
import org.example.Heuristics.ReplacementHeuristics.GenerationalReplacement;
...
public class GenerationalReplacementTest {
    ...
    public void testRecombine() {
        ...
        List<Double> expectedFitness = Arrays.asList(1.0/13, 1.0/4, 1.0/13, 1.0/4);
        ...
        assertEquals(expectedFitness, actualFitness, "Should select all offspring");
    }
